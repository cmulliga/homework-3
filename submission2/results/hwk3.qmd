...
#| eval: true
#| 
load("C:/Users/ctmul/Emory_Files/ECON_470-1/homework-3/submission2/hwk3_workspace.Rdata")
```
...
The coefficient for the second stage is .502 which is a different effect than the first stage result, but the same as my answer for question 7. This is unexpected and may be a result of error as one might expect it to be negative.
